...
import { QueryBySpecialistService } from '@backend/services/reports/query-by-specialist.service';
...
import { data_fake_queries_by_specialist, QueryBySpecialist } from './../../../mock_values/report/query-by-specialist';

@Component({
  selector: 'app-query-by-specialist',
  templateUrl: './query-by-specialist.component.html',
  styleUrls: ['./query-by-specialist.component.scss']
})
export class QueryBySpecialistComponent implements OnInit {
  ...
  public subjects: any[];
  constructor(
    private queryBySpecService: QueryBySpecialistService,
  ...
  public initColumName() {
    this.displayedColumns = ['select', 'specialist', 'teachType', 'category', 'date', 'queriesAttended'];
  ...
  public filterData() {
    ...
    // this.dataSource = new MatTableDataSource<QueryBySpecialist>(data_fake_queries_by_specialist);
    // TODO: fill data from the api
    //chart data values
  ...
  public getCharData(params: any) {
    this.queryBySpecService.getChartData(params).subscribe(
      response => {
  ...
  public getSummaryData(params: any) {
    this.queryBySpecService.getSummaryData(params).subscribe(
      response => {
  ...
  */
  ...
  private research() {
    this.router.navigate(['backend/report/query-by-specalist'], {
...
// this.pinarProvinceData = "Pinar del Río";
    ...
    // {{getValue('Guantánamo')|mapColorByClass}}
